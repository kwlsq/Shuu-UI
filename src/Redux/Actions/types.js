//action types userReducers.js
export const LOGIN_SUCCESS = 'LOGIN_SUCCESS';
export const LOGOUT = 'LOGOUT';
export const REGISTER_SUCCESS = 'REGISTER_SUCCESS';
export const REGISTER_FAIL = 'REGISTER_FAIL';
export const SHOW_USER_TABLE = 'SHOW_USER_TABLE';
export const SHOW_USER_DETAIL = 'SHOW_USER_DETAIL';

//action types loginReducers.js & registerReducers.js
export const INPUT_TEXT = 'INPUT_TEXT';

//action types brandsReducers.js
export const SHOW_OFFICIAL_STORES = 'SHOW_OFFICIAL_STORES';

//action types productsReducers.js
...
export const EDIT_DELIVERY_PROVINCE = 'EDIT_DELIVERY_PROVINCE';
export const EDIT_DELIVERY_CITY = 'EDIT_DELIVERY_CITY';
